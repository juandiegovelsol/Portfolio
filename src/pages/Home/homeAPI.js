    ...
    bodyrigth: [
      ...
      },
      {
        ...
        info: [
          ...
          {
            subtitle1:
              "Professional Trader, Pro Trading Skills, New York - Remote",
    ...
    bodyrigth: [
      ...
      },
      {
        ...
        info: [
          {
            subtitle1:
              "Desarrollador Full Stack, Make It Real, Medellin - Remoto",
            subtitle2: "Septiembre 2022 — Junio 2023",
            list: [
              "Durante mi participación en el programa de desarrollo full-stack en Make It Real, demostré dedicación, perseverancia y una gran motivación para aprender. Fui reconocido por mi enfoque en el desarrollo de código de alta calidad, siempre siguiendo las mejores prácticas de la industria.",
              "A lo largo del programa, obtuve sólidos conocimientos en tecnologías clave como HTML, CSS, JavaScript, React, Node.js, Express y bases de datos. A través de proyectos prácticos y desafiantes, pude aplicar este conocimiento y desarrollar habilidades para crear aplicaciones web interactivas y escalables.",
              "Mi compromiso con la excelencia se reflejó en una atención meticulosa a los detalles, una búsqueda constante de mejora y una voluntad de asumir nuevos desafíos. Trabajé colaborativamente en equipos, mostrando habilidades de comunicación efectiva y la capacidad de adaptarme a entornos dinámicos.",
            ],
          },
          {
            subtitle1:
              "Trader Profesional, Pro Trading Skills, New York - Remoto",
            subtitle2: "Enero 2021 — Diciembre 2021",
            list: [],
          },
          {
            subtitle1: "Ingeniero Mecatrónico, Universidad EIA, Medellín",
            subtitle2: "Julio 2014 — Julio 2021",
            list: [
              "Como ingeniero mecatrónico, adquirí una sólida formación en programación orientada a objetos, desarrollo web e Internet de las cosas (IoT).",
              "Durante mis estudios en IoT, aprendí los fundamentos del desarrollo web y cómo integrarlo con dispositivos electrónicos. Esto me permitió comprender cómo crear aplicaciones web interactivas conectadas a varios dispositivos, lo cual es crucial en el campo de IoT.",
            ],
          },
        ],
      },
